...
import { createSession, startSession, stopSession, sendOutro, analyzeSession } from '../controllers/avatar.controller.js';
...
// The frontend makes a POST request here to actually start the streaming engine
